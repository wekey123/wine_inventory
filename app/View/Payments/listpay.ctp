   ...
   <div class="container">
     <div class="row">
        <div class="col-md-12">
            ...
            <?php if(!empty($this->params['pass'][0])){ $paramsId = $this->params['pass'][0]; }else{ $paramsId = 'ALL'; } ?>
            <div class="form-group">
             ...
             <form method="post" name="searchSort">
         	  <p>
               From: <input class="datepicker" id="dateFrom" name="dateFrom" type="text" value="<?php echo isset($data) ? $data['dateFrom'] : ''?>"> 
               To: <input class="datepicker" name="dateTo" id="dateTo" type="text" value="<?php echo isset($data) ? $data['dateTo'] : ''?>">
           		<button class="buttApply" style="margin-left:20px;">APPLY</button></p>
           </form>
        </div>
        <div class="col-md-12">
...
<script>
	$/*('#filterVendor').on('change',function(e){
		window.location = '/payments/mew/'+$(this).val();
	});	*/
