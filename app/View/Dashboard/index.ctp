        ...
        <div class="row">
             <div class="col-md-3 col-sm-3 col-xs-6">
                <div class="dashboard-div-wrapper bk-clr-one">
                    <i  class="fa dashboard-div-icon" ><?php echo $Count['Product']; ?></i>
...
<div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
             ...
             <div class="col-md-3 col-sm-3 col-xs-6">
                <div class="dashboard-div-wrapper bk-clr-two">
                   ...
                   <i  class="fa dashboard-div-icon" ><?php echo $Count['Order']; ?></i>
                    <div class="progress progress-striped active">
             ...
             <div class="col-md-3 col-sm-3 col-xs-6">
                <div class="dashboard-div-wrapper bk-clr-three">
                   <!-- <i  class="fa fa-cogs dashboard-div-icon" ></i>-->
                    <i  class="fa dashboard-div-icon" ><?php echo $Count['Invoice']; ?></i>
                    <div class="progress progress-striped active">
<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%">
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <div class="dashboard-div-wrapper bk-clr-four">
                    ...
                    <i  class="fa dashboard-div-icon" ><?php echo $Count['Inventory']; ?></i>
                    <div class="progress progress-striped active">
<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%">
</div>
                       
</div>
					 <?php echo $this->Html->link('Inventory',array('controller'=>'inventories','action' => 'lists'),array('class'=>'dasboard_link')); ?>
                </div>
            </div>
